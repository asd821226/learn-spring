...
/**
 * Evaluation context class that adds a method parameters as SpEL variables, in a lazy manner. The
 * lazy nature eliminates unneeded parsing of classes byte code for parameter discovery.
 *
 * <p>
